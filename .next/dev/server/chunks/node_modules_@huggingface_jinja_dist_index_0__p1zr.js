module.exports = [
"[project]/node_modules/@huggingface/jinja/dist/index.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        return this._builtins ??= /* @__PURE__ */ new Map([
            ...
            [
                ...
                new FunctionValue((args)=>{
                    ...
                    const items = Array.from(this.value.entries()).map(([key, value])=>new ArrayValue([
                            new StringValue(key),
                            value
                        ])).sort((a, b)=>{
 ...
 */ __publicField(Environment, "TESTS", /* @__PURE__ */ new Map([
    ...
    [
        "mapping",
        (operand)=>operand instanceof ObjectValue
    ],
    [
        "sequence",
...
//# sourceMappingURL=node_modules_%40huggingface_jinja_dist_index_0__p1zr.js.map