    ...
    try {
        ...
        if (Array.isArray(body.messages)) {
            ...
            rawMessages = [
                {
                    role: "user",
                    content: body.prompt || body.message || body.text
                }
            ];
        }
        ...
        const input = rawMessages.filter((m)=>(m.role === "user" || m.role === "assistant") && typeof m.content === "string" && m.content.trim()).map((m)=>({
                role: m.role,
                content: m.content
            }));
        const response = await client.responses.create({
            model: "gpt-5.6-luna",
            instructions: "You are My AI, a helpful, concise and professional personal assistant. Maintain conversation context and answer naturally.",
            input
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: error?.message || "OpenAI request failed. Please check your API key and project."
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0mmq-bq._.js.map